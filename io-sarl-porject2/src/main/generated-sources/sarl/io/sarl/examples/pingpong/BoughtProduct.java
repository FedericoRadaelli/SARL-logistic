...
public class BoughtProduct extends Event {
  public final int raw;

  public final int qty;

  public BoughtProduct(final int raw, final int qty) {
    this.raw = raw;
    this.qty = qty;
  }
  ...
  /**
   * Returns a String representation of the BoughtProduct event's attributes only.
   */
  @SyntheticMember
  @Pure
